...
# wget --load-cookies /tmp/cookies.txt "https://drive.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://drive.google.com/uc?export=download&id=1F5RQSM9vm45DR3PTcxGWvBFgRAXnctKg' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=1F5RQSM9vm45DR3PTcxGWvBFgRAXnctKg" -O $script_dir/weights/weights_2022_12_01_resnet_pretrain.pth && rm -rf /tmp/cookies.txt

# https://drive.google.com/file/d/12wG1-Mn-a-O5_mgx3-V3qissycmVx0Lx/view?usp=sharing
wget --load-cookies /tmp/cookies.txt "https://drive.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://drive.google.com/uc?export=download&id=12wG1-Mn-a-O5_mgx3-V3qissycmVx0Lx' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=12wG1-Mn-a-O5_mgx3-V3qissycmVx0Lx" -O $script_dir/weights/weights_2022_12_08_resnet_pretrain.pth && rm -rf /tmp/cookies.txt
